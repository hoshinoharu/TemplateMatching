package com.reharu.robotic.opencv;
...
public class OpencvImage {
	...
	public Rect templateMatches(OpencvImage dstImg) {
		...
		try {
			...
			Imgproc.cvtColor(dst, tempDst, Imgproc.COLOR_RGB2GRAY);
...
//					new Scalar(0, 255, 0));
//			// 将结果输出到对应位置
//			Imgcodecs.imwrite(System.currentTimeMillis() + ".png", tempSrc);
